...
user1 = User.create(username: 'Emily')
##password: 'musiclover')
...
album2 = Album.create(name: 'Blonde', artist: 'Frank Ocean', year: 2016, image: 'https://hips.hearstapps.com/ell.h-cdn.co/assets/16/34/480x480/square-1471882460-frank-ocean-blonde.jpg?resize=640:*')
...
review1 = Review.create(title: 'Best Album Ever', description: 'This is my favorite album of all time', rating: 5, user_id: 1, album_id: album1.id)
